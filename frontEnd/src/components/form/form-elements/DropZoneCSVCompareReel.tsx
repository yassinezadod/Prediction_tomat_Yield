...
const DropZoneCSVCompareReel: React.FC<DropzoneCSVComponentProps> = ({ onFilesAccepted }) => {
            ...
            {files.length > 0 ? (
              ...
              <>
                <h4 className="mb-3 font-semibold text-gray-800 dark:text-white/90">
                  {isDragActive ? "Drop CSV File With Actual Values Here" : "Drag & Drop CSV File With Actual Values Here"}
                </h4>
                <span className="text-center mb-5 block w-full max-w-[290px] text-sm text-gray-700 dark:text-gray-400">
                  Drag and drop your CSV file containing the column "Rendement (t/ha)"
                </span>
...
export default DropZoneCSVCompareReel;
