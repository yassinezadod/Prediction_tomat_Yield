...
import ComponentCardCSV from "../../common/ComponentCardCsv";
...
const DropzoneCSVComponent: React.FC<DropzoneCSVComponentProps> = ({ onFilesAccepted }) => {
  ...
  return (
    <ComponentCardCSV title="Dropzone">
