...
export default function ModelPredictionChart({ csvData = [] }: ModelPredictionChartProps) {
  ...
  const getQuickStats = () => {
    ...
    return {
      ...
      maxPrediction: maxPrediction.toFixed(2),
      minPrediction: minPrediction.toFixed(2),
      ...
      <div className="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        <div className="w-full">
          <h3 className="text-lg font-semibold text-gray-800 dark:text-white/90">
            Prédiction de Rendement par Semaine
          </h3>
          <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
            Évolution des prédictions de rendement selon les semaines
          </p>
        </div>
        ...
        {stats && (
          <div className="flex items-start w-full gap-3 sm:justify-end">
            <div className="grid grid-cols-3 gap-3 text-sm">
              ...
              <div className="text-center">
                <div className="text-blue-800 font-semibold">{stats.maxPrediction}</div>
                <div className="text-gray-500 text-xs">Maximum</div>
              </div>
              <div className="text-center">
                <div className="text-blue-400 font-semibold">{stats.minPrediction}</div>
            ...
            <div className="flex items-center justify-center h-[280px] bg-gray-50 rounded-lg">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-xs mt-1">
                  Veuillez télécharger vos fichiers CSV pour voir les prédictions
                </p>
              </div>
            </div>
          )}
      ...
      {stats && (
        <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
          <div className="flex justify-between items-center text-xs text-gray-500">
            ...
            <span>Écart (Max - Min): {(parseFloat(stats.maxPrediction) - parseFloat(stats.minPrediction)).toFixed(2)} t/ha</span>
          </div>
        </div>
      )}
    </div>
